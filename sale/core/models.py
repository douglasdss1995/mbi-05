...
class BaseModel(models.Model):
    ...
    created_at = models.DateTimeField(null=False, auto_created=True, verbose_name='Created at', db_column='created_at')
    modified_at = models.DateTimeField(null=False, auto_now_add=True, verbose_name='Modified at', db_column='modified_at')
