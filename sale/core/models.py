...
class ProductGroup(NameBaseModel):
    commission_percentage = models.DecimalField(null=False, blank=False, max_digits=6, decimal_places=2)
    gain_percentage = models.DecimalField(null=False, blank=False, max_digits=6, decimal_places=2)
...
class Employee(NameBaseModel):
    ...
    gender = models.CharField(null=False, blank=False, max_length=1, choices=(('M', 'Male'), ('F', 'Female')))
