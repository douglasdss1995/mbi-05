...
class BaseModel(models.Model):
    ...
    created_at = models.DateTimeField(null=True, auto_created=True, verbose_name='Created at', db_column='created_at', default=timezone.now())
    modified_at = models.DateTimeField(null=True, auto_now_add=True, verbose_name='Modified at', db_column='modified_at', default=timezone.now())
